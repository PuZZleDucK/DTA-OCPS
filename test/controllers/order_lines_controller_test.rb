...
class OrderLinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_line" do
    assert_difference('OrderLine.count') do
      post order_lines_url, params: { order_line: { item_id: @order_line.item_id, order_id: @order_line.order_id, quantity: @order_line.quantity } }
    end
  ...
  test "should update order_line" do
    patch order_line_url(@order_line), params: { order_line: { item_id: @order_line.item_id, order_id: @order_line.order_id, quantity: @order_line.quantity } }
